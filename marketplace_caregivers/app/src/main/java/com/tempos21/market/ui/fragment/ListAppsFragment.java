...
public final class ListAppsFragment extends Fragment implements OnModeChangedListener, OnLoadingStatusListener, OnItemClickListener {
    ...
    public ListAppsFragment(Activity context) {
    ...
    public void onGetAppsServiceResponse(boolean success, Apps apps) {
        if (success && apps != null && apps.size() > 0) {
            ...
            if (allApps.size() == 0) {
                ...
                if (success) {
                    notConnection.setText(R.string.noAppsToShow);
                } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null) {
            ...
            AppWithImage myapp = new AppWithImage();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (Connection.netConnect(context)) {
            ...
            sectionTitle.setText(R.string.latest);
            notConnection.setVisibility(View.VISIBLE);
