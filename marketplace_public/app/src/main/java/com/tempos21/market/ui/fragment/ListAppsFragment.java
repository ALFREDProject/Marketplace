...
public final class ListAppsFragment extends Fragment implements GenericView<List<App>>, OnItemClickListener, OnLoadingStatusListener {
    ...
    private void setCategory(){
        ...
        if(!categoryId.equalsIgnoreCase("")){
			...
			textTypeList.setText(R.string.latest);
		}
    }


	public void getData(){
		presenter = new AppListPresenterImpl(this);
