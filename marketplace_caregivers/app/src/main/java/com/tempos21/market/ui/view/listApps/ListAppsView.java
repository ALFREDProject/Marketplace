...
//	private static final int GRID_COLUMNS_PHONE = 3;
     ...
     */
    public void setApps(AppsWithImage apps) {
        this.apps = apps;
     ...
     * @param apps
     */
    public void addApps(AppsWithImage apps) {
    ...
    public void setMode(boolean listMode) {
    ...
    private void setData() {
        if (status != STATUS_FIRST_LOAD && apps != null && apps.size() >= 0) {
            ad = new AppsAdapter(context, apps, listMode);
...
//				return LIST_COLUMNS_TABLET; // List Mode for table
//			} else {
//				return LIST_COLUMNS_PHONE; // List Mode for phone
//			}
...
//			if (Device.isTablet(context)) {
//				return GRID_COLUMNS_TABLET; // Grid Mode for tbalet
//			} else {
//				return GRID_COLUMNS_PHONE; // List Mode for Tablet
//			}
        }
