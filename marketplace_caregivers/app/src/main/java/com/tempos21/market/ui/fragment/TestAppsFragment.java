...
public final class TestAppsFragment extends Fragment implements OnModeChangedListener, OnLoadingStatusListener, OnGetAppsServiceResponseListener, OnItemClickListener {
    private View me;
    ...
    public TestAppsFragment() {

    }

    public TestAppsFragment(Activity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (Connection.netConnect(context)) {
            ...
            sectionTitle.setText(R.string.menuTesting);
    ...
    private void getData() {
        sectionTitle.setText(getString(R.string.menuTesting));
        searchAppsService = new GetAppsService(Constants.GET_TESTING_APPS_SERVICE, getActivity());
        ...
        if (responseCode == ServiceErrorCodes.OK && apps != null && apps.size() > 0) {
            ...
            if (responseCode == ServiceErrorCodes.LOGIN_ERROR) {
                ...
                if (responseCode == ServiceErrorCodes.HTTP_OK) {
                    notConnection.setText(R.string.not_test);
                } else {
    ...
    public void onItemClick(App app) {
        ...
        i.putExtra(AppActivity.EXTRA_CAN_REVIEW, false);
        i.putExtra(AppActivity.EXTRA_TESTING, "" + app.getVersion_number());
        i.putExtra(AppActivity.EXTRA_DOWNLOAD_APP, 1);
        startActivity(i);
    }
